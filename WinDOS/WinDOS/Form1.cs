    ...
    public class DiscEngine
    {
        ...
        private void HELP(bool regedit, DiscOperatingSystem form)
        {
            ...
            else
            {
                ...
                Environment.NewLine + Environment.NewLine + "CSK                          Changes current subkey;  " +
                ...
                Environment.NewLine + Environment.NewLine + "SK-GET                       Returns a subkey list of a specified subkey;" +
                ...
                Environment.NewLine + Environment.NewLine + "VAL-GET                      Returns all registry values in the specified subkey;" +
                ...
                Environment.NewLine + "                             Usage: val-make [valueName(Use hashmarks instead of spaces!)] [value(Use hashmarks instead of spaces!)] {[valueKind(none/unknown/string/multistring/expandstring/dword/qword/binary)]};" +
                Environment.NewLine + "                             Example: val-make NewValue This#is#a#string#value string" +

                Environment.NewLine + Environment.NewLine + "VAL-DELETE                   Deletes the specified value;" +
                Environment.NewLine + "                             Usage: val-delete [valueName];" +
                Environment.NewLine + "                             Example: val-delete valueToDelete" +

                Environment.NewLine + Environment.NewLine + "VAL-RENAME                   Renames the specified value;" +
